...
class CheckoutForm extends React.Component {
  ...
  handleSubmit = async (event) => {
    ...
    if (payload.error) {
      // fail payment: next steps
      this.setState({error: payload.error});
      console.log("fail");
    } else {
      // successful payment: next steps
      this.setState({paymentMethod: payload.paymentMethod});
      
      console.log("success");
      console.log("tell backend to send an email");
...
const stripePromise = loadStripe('pk_test_ewsTveHyVK4CaZYFysPoekry00Q63Yoswr');
